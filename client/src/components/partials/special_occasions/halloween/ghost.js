...
function Ghost(props){
	...
	return <div className='halloween_ghost'>
        ...
        width="127.433px" height="132.743px" viewBox="0 0 127.433 132.743" enableBackground="new 0 0 127.433 132.743" xmlxspace="preserve">
            ...
            <circle fill={fill} cx="86.238" cy="57.885" r="6.667"/>
            <circle fill={fill} cx="40.072" cy="57.885" r="6.667"/>
            <path fill={fill} d="M71.916,62.782c0.05-1.108-0.809-2.046-1.917-2.095c-0.673-0.03-1.28,0.279-1.667,0.771
