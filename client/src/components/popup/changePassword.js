...
function ChangePassword(props) {
    ...
    return <div className="changePassword">
        ...
        {error ? <div className="alert alert-danger">
            <p className="text_red">{translate({lang, info: "empty_input_change_username"})}</p>
        </div> : null}
        {errorPassword ? <div className="alert alert-danger">
            <p className="text_red">{translate({lang, info: "password_rule01"})}</p> 
            <p className="text_red">{translate({lang, info: "password_rule02"})}</p> 
            <p className="text_red">{translate({lang, info: "password_rule03"})}</p> 
            <p className="text_red">{translate({lang, info: "password_rule04"})}</p> 
            <p className="text_red">{translate({lang, info: "password_rule05"})}</p>
        </div> : null}
