...
function slot_game(props, id){
	...
	this.ready = function(r){
		...
		let payload = {uuid: props.data.uuid, reel:reel.length, items:items.length, reason: reason}	
...
function Slot(props) {	
	...
	useEffect(() => {		
		...
		$(window).resize(function(){
			if(document.getElementById("slot_machine_lines")){
